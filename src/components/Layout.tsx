        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            <Link to="/" className="flex items-center space-x-2 text-[#8b5cf6] hover:text-white transition-colors">
              ...
              <span className="text-lg sm:text-xl font-bold font-mono tracking-wider">Vixo</span>
            </Link>

            <div className="flex items-center space-x-2 sm:space-x-6">
              <Link
                to="/"
                className={`flex items-center space-x-1 px-2 py-2 sm:px-3 rounded-lg transition-colors touch-target ${
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 px-2 py-2 sm:px-3 rounded-lg text-gray-300 hover:text-white hover:bg-red-600/20 transition-colors touch-target"
                  >
                    <div className="flex items-center justify-center w-4 h-4">
                ...
                <Link
                  to="/login"
                  className="flex items-center space-x-1 px-3 py-2 sm:px-4 rounded-lg bg-[#8b5cf6] text-white hover:bg-[#8b5cf6]/80 transition-colors touch-target"
                >
                  <div className="flex items-center justify-center w-4 h-4">
